  ...
  public static void main(String[] args) throws IOException, URISyntaxException {
    ...
    if (args.length > 3) {
      ...
      if (named != null) {
        ...
        // Configure app file name
        if (named.containsKey("app-file")) {
          appFile = named.get("app-file");
          System.out.println("app-file: " + appFile);
        }
    ...
    File lFile = appPath.resolve(appFile).toFile();
    System.out.println("Writing manifest to file " + lFile.getCanonicalPath());

    JAXB.marshal(manifest, lFile);
  }
